...
(async () => {
  const postsDataToIndex = [
    ...
    },
    {
      userId: 1,
      id: 2,
      title: 'qui est esse batman robin',
  ...
  const usersDataToIndex = [
    ...
    },
    {
      ...
      favoritePets: [
        { name: 'batman robin is here', species: 'cat' },
    ...
    },
    {
      ...
      favoritePets: [
        { name: 'spurkle batman is my dog', species: 'dog' },
        { name: 'dori', species: 'fish' },
      ],
    },
  ];

  const postsCollectionExists = client.collections('posts').exists();

  if (postsCollectionExists) {
    client.collections('posts').delete();
  }

  const usersCollectionExists = client.collections('users').exists();
  ...
  postsDataToIndex.forEach(async (document) => {
